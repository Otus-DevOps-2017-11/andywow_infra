...
Проверил `terraform plan` - предложил сменить только IP-адрес для SSH-правила фаервола, значит работает. Попробовал `terraform apply`. Изменения применились.
